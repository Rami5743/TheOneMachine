...
const SCENES = {
  ...
  "arithmetic": {
    ...
    "panels": [
      ...
      {
        "comment": "The bits-range dialogue: shown once, right after all binary-booklet tasks are completed (see binWalkthroughFinish). These slides reuse the workshop-vn art with an overlaid speech bubble; two of them gate advancement behind a numeric answer.",
        "image": "assets/panels/panel106_chapter_2_5_workshop_vn.svg",
        "year": "1943",
        "bubble": "מצוין, אני רואה שהבנת את הפרינציפ. עכשיו צריך ללמד את זה את המחשב שלנו. אנחנו יכולים לייצג מספרים באמצעות רצף של ביטים. אם אנחנו רוצים לבנות כרטיס שיבצע פעולה עם מספרים, אנחנו נכניס לתוכו בסים שייצגו מספרים. בס ברוחב 4 יכול לייצג מספר 4 ספרתי בשיטה הבינרית. אני לא בטוח שזה מספיק לנו. מה המספר הכי גדול שאפשר לייצג כך?",
      ...
      },
      {
        "image": "assets/panels/panel106_chapter_2_5_workshop_vn.svg",
        "year": "1943",
        "bubble": "נכון. המספר ה-5 ספרתי הכי קטן הוא 10000₂ שזה בעצם 16. לכן המספר ה-4 ספרתי הכי גדול, הוא אחד פחות מזה 1111₂ שזה בעצם 15.",
      ...
      },
      {
        "image": "assets/panels/panel106_chapter_2_5_workshop_vn.svg",
        "year": "1943",
        "bubble": "זה ממש לא מספיק לנו. אנחנו צריכים לפעמים מספרים בגודל של עשרות אלפים. אני מניח שמספרים עד 50,000 יספיקו לנו. כמה ביטים נצטרך בשביל זה?",
      ...
      },
      {
        "image": "assets/panels/panel106_chapter_2_5_workshop_vn.svg",
        "year": "1943",
        "bubble": "נכון. עם 10 ביטים אפשר לייצג 1024 מספרים שזה בערך 1000. לאחר מכן כל ביט מכפיל פי-2, לכן עם 15 ביטים אפשר לייצג בערך 32,000 מספרים, שזה עוד לא מספיק לנו. אבל עם 16 ביטים אפשר לייצג 64,000 מספרים שזה כבר סבבה לבינתיים.",
      ...
      },
      {
        "image": "assets/panels/panel106_chapter_2_5_workshop_vn.svg",
        "year": "1943",
        "bubble": "כשאני מדבר על מספרים 16 ספרתיים אני כמובן כולל גם מספרים עם פחות ספרות, פשוט אפשר לכתוב 0 בספרות שלא מופיעות. אפשר לעשות את זה גם בשיטה העשרונית. למשל, לכתוב 032 במקום 32. ביום יום זה לא מקובל, כי ה-0 סתם נראה מיותר, אבל בעולם של מכונות חישוב, זה מאוד נוח, כי המכונות שלנו עובדות עם מספר קבוע של ספרות, אנחנו הרי לא רוצים לחבר כל פעם את החוטים מחדש. לכן, אנחנו קובעים מראש את מספר הספרות וכותבים 0 בספרות שלא צריך. אנחנו גם מקפידים שלא לחרוג ממספר הספרות שקבענו.",
      ...
      },
      {
        "image": "assets/panels/panel106_chapter_2_5_workshop_vn.svg",
        "year": "1943",
        "bubble": "אחרי שהוא יהיה מוכן יהיה אפשר לבנות כרטיס שמחבר מספרים רב ספרתיים (במקרה שלנו 16 ספרתיים בכתיבה בינרית).",
        "read": "אחרי שהוא יהיה מוכן יהיה אפשר לבנות כרטיס שמחבר מספרים רב ספרתיים (במקרה שלנו 16 ספרתיים בכתיבה בינרית)."
      },
      {
        "image": "assets/panels/panel106_chapter_2_5_workshop_vn.svg",
        "year": "1943",
        "bubble": "יש רק בעיה קטנה אחת: סכום של שני מספרים 16 ספרתיים הוא לעיתים 17 ספרתי. אנחנו נתעלם מהספרה המובילה, כי במחשב כל החיבורים קבועים, ואנחנו לא יכולים להרחיב אותם בלי די. כל עוד כל המספרים המעורבים (כולל התוצאה) לא יעלו על 64,000, זה יהיה בסדר. אם נעבור את הגודל המותר זה יוביל לתקלה שנקראת גלישה נומרית (Integer overflow). ננסה להימנע מזה...",
      ...
      {
        "comment": "Wordless beat (zip file 1): von Neumann picks up the note to hand over the tasks.",
        "image": "assets/panels/panel108_chapter_2_5_workshop_handover.svg",
        "year": "1943",
        "read": ""
      },
      {
        "comment": "Zip file 2: von Neumann in the doorway, handing over the tasks and leaving for Bohr.",
        "image": "assets/panels/panel109_chapter_2_5_workshop_doorway.svg",
        "year": "1943",
        "bubble": "טוב, הנה המשימות שלך. אני צריך לחזור לנילס. יש לו רעיון הזוי לחלוק עם הקומוניסטים את הפרויקט שלנו. אני צריך להוריד אותו מזה, ומהר. אומנם עכשיו יש לנו אויב משותף, אבל סטלין לא הרבה פחות גרוע מהיטלר, וזה יהיה אסון לתת לו נשק כזה, גם אם זה יקדם אותנו קצת בפרויקט. מצד שני קשה לשפוט את נילס, הוא היה בדנמרק כשהנאצים נכנסו ושמע מקרוב על הזוועות של הנאצים שעליהם אנחנו שומעים מרחוק.",
      ...
      {
        "comment": "Zip file 3: the empty arithmetic worktable. Click-zones mirror panel107, plus a (not-yet-implemented) tasks-note zone. These are fallback percentages until a hotspot-carrying SVG replaces the PNG.",
        "image": "assets/panels/panel110_chapter_2_5_workshop_tasks.svg",
        "year": "1943",
        "read": "",
        "hotspots": [
