  ...
  "einstein-letter": {
    ...
    "panels": [
      ...
      },
      {
        ...
        "read": "סילארד: אתה יודע על מה! אנשים קוראים המאמר שכתבתי לפני 5 שנים. האן ושטרסמן עשו ניסויים עם אורניום, שהוכיחו שהוא מתבקע. היזנברג חושב על זה. נילס בור כתב לי שהיזנברג נפגש איתו ושאל שאלות. נילס כמובן נפנף אותו, אבל אתה יודע שהיזנברג לא טיפש."
      },
      {
  ...
  "oppenheimer-von-neumann-1943": {
    ...
    "panels": [
      ...
      },
      {
        ...
        "femaleRead": "פון נוימן: את! את נראית לי ברנש לעניין. יש לי משימה סודית עבורך. את מכירה את המקצוע מחשב, את יודעת, בן אדם שהתפקיד שלו זה לחשב."
      },
      {
