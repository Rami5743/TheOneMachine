  ...
  const RAM_TASKS = [
    {
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 3", text: "בנית כבר כרטיס שמעביר כניסה אחת לאחת מארבע יציאות לפי בס בקרה של 2 ביטים — DMux4Way. תן לו את כניסת הבקרה, ואת בס הכתובת בתור הבקרה שלו." },
        { kind: "text", title: "רמז 4", text: "וליציאה יש את הכרטיס ההפוך: Mux4Way16 בוחר אחד מארבעה בסים לפי אותו בס בקרה. חבר אליו את היציאות של ארבעת הרגיסטרים, ואת אותו בס כתובת." }
      ]
    },
    {
      id: "Ram16",
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 3", text: "2 ביטי הכתובת הפנימיים מתחברים לכל ארבעת הכרטיסים במקביל. שני הביטים האחרים הם בס הבקרה של DMux4Way (שמנתב את כניסת הבקרה) ושל Mux4Way16 (שבוחר את היציאה) — בדיוק כמו ב-Ram4." }
      ]
    },
    {
      id: "Ram64",
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 3", text: "4 ביטי הכתובת הפנימיים מתחברים לכל ארבעת הכרטיסים במקביל. שני הביטים האחרים הם בס הבקרה של DMux4Way (שמנתב את כניסת הבקרה) ושל Mux4Way16 (שבוחר את היציאה) — בדיוק כמו ב-Ram4." }
      ]
    },
    {
      id: "Ram256",
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 3", text: "6 ביטי הכתובת הפנימיים מתחברים לכל ארבעת הכרטיסים במקביל. שני הביטים האחרים הם בס הבקרה של DMux4Way (שמנתב את כניסת הבקרה) ושל Mux4Way16 (שבוחר את היציאה) — בדיוק כמו ב-Ram4." }
      ]
    },
    {
      id: "Ram1024",
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 3", text: "8 ביטי הכתובת הפנימיים מתחברים לכל ארבעת הכרטיסים במקביל. שני הביטים האחרים הם בס הבקרה של DMux4Way (שמנתב את כניסת הבקרה) ושל Mux4Way16 (שבוחר את היציאה) — בדיוק כמו ב-Ram4." }
      ]
    }
  ];
