...
AND ו־NOT הם כרטיסים שמבצעים חישוב.`,
  ...
  const SPLITTER_MONOLOGUE = {
    ...
    outro: "יש לי שני צדדים. לצד אחד מחברים בס, ומהצד השני יוצאים מספר כבלים או בסים. לחיצה כפולה עליי בשולחן העבודה מאפשרת לשנות את מספר הבסים (או הכבלים). אני תמיד מפצל את הבס שווה בשווה. אם הופכים אותי אפשר להשתמש בי לכיוון השני – אני מחבר כמה בסים שווים (או כבלים בודדים) לבס אחד רחב יותר. שים לב לחץ שעליי, הוא מציין את סדר החלקים שאני מפצל אליהם."
  };
