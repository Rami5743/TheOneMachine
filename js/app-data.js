  ...
  const RAM_TASKS = [
    {
      ...
      addressWidth: 2,
      controlPinX: -217,
      innerCardSpots: [[740, 365], [705, 460], [660, 575], [580, 685]],
      slots: 4,
      clocked: true,
    ...
    },
    {
      ...
      addressWidth: 4,
      controlPinX: -217,
      innerCardSpots: [[765, 315], [730, 430], [675, 560], [575, 670]],
      slots: 16,
      clocked: true,
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 3", text: "פצל את בס הכתובת (4 ביטים) לשניים: 2 ביטים שנכנסים לכניסת הכתובת של כל ארבעת ה-RAM4, ו-2 ביטים שבוחרים לאיזה מהם פונים." },
        { kind: "text", title: "רמז 4", text: "2 ביטי הכתובת הפנימיים מתחברים לכל ארבעת הכרטיסים במקביל. שני הביטים האחרים הם בס הבקרה של DMux4Way (שמנתב את כניסת הבקרה) ושל Mux4Way16 (שבוחר את היציאה) — בדיוק כמו ב-RAM4." }
      ]
    },
    {
      id: "RAM64",
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 3", text: "פצל את בס הכתובת (6 ביטים) לשניים: 4 ביטים שנכנסים לכניסת הכתובת של כל ארבעת ה-RAM16, ו-2 ביטים שבוחרים לאיזה מהם פונים." },
        { kind: "text", title: "רמז 4", text: "4 ביטי הכתובת הפנימיים מתחברים לכל ארבעת הכרטיסים במקביל. שני הביטים האחרים הם בס הבקרה של DMux4Way (שמנתב את כניסת הבקרה) ושל Mux4Way16 (שבוחר את היציאה) — בדיוק כמו ב-RAM4." }
      ]
    },
    {
      id: "RAM256",
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 3", text: "פצל את בס הכתובת (8 ביטים) לשניים: 6 ביטים שנכנסים לכניסת הכתובת של כל ארבעת ה-RAM64, ו-2 ביטים שבוחרים לאיזה מהם פונים." },
        { kind: "text", title: "רמז 4", text: "6 ביטי הכתובת הפנימיים מתחברים לכל ארבעת הכרטיסים במקביל. שני הביטים האחרים הם בס הבקרה של DMux4Way (שמנתב את כניסת הבקרה) ושל Mux4Way16 (שבוחר את היציאה) — בדיוק כמו ב-RAM4." }
      ]
    },
    {
      id: "RAM1024",
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 3", text: "פצל את בס הכתובת (10 ביטים) לשניים: 8 ביטים שנכנסים לכניסת הכתובת של כל ארבעת ה-RAM256, ו-2 ביטים שבוחרים לאיזה מהם פונים." },
        { kind: "text", title: "רמז 4", text: "8 ביטי הכתובת הפנימיים מתחברים לכל ארבעת הכרטיסים במקביל. שני הביטים האחרים הם בס הבקרה של DMux4Way (שמנתב את כניסת הבקרה) ושל Mux4Way16 (שבוחר את היציאה) — בדיוק כמו ב-RAM4." }
      ]
    }
  ];
