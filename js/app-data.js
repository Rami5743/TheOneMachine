  ...
  const CASES_TASKS = [
    {
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 2", text: "תן תגית לשורה הראשונה של כל אחד מחמשת החלקים: חיבור, חיסור, כפל, חילוק, ריבוע. ככה ההחלטה בראש התוכנה יכולה לקפוץ לכל חלק בשם שלו, ואתה לא צריך לדעת מראש באיזו שורה כל חלק מתחיל — הגמד ימלא את המספרים במקומך." },
      ...
      },
      {
        ...
        program: [
          ...
          { bits: "0100000001001000", label: "עוד" },
          { bits: "1000010000110100" },
          ...
          { bits: "1000010000110100" },
          { bits: "0000000101001000", shows: "עוד" },
          ...
          { bits: "0000000000001000" },
          { bits: "1000000011001100" },
          { bits: "0100000001001000", label: "שוב" },
          { bits: "1000010000110100" },
          { bits: "0100000000001000" },
          { bits: "1000010100001100" },
          { bits: "0000000000001000" },
          { bits: "1000010100111100" },
          { bits: "1000010000110100" },
          { bits: "0000001001011000", shows: "שוב" },
          { bits: "1000001111000001" },
          { bits: "0000010100101000", shows: "סוף" },
          { bits: "1000000101010010" },
          ...
          { bits: "0000000000001000" },
          { bits: "1000000011001100" },
          { bits: "0100000001011000", label: "חלוקה" },
          { bits: "1000010000110100" },
          { bits: "0000000000001000" },
          ...
          { bits: "0000000000001000" },
          { bits: "1000010000110100" },
          { bits: "0000001101101000", shows: "חלוקה" },
        ...
        steps: [
          ...
          { code: "1028 → A", row: 19, text: "תחילת הלולאה, ולכן יש לשורה תגית. מכאן והלאה זו בדיוק לולאת הכפל שכתבת בפרק הקודם: מחברים את In0 ל-Out0, מורידים 1 מהמונה, ובודקים אם נשאר עוד." },
      ...
      },
      {
        ...
        program: [
          { bits: "0100000001101000" },
          { bits: "1000010000110100" },
          { bits: "0000001110011000", shows: "חיבור" },
          { bits: "1000000011000010" },
          { bits: "1000000111000100" },
          { bits: "0000010000011000", shows: "חיסור" },
          { bits: "1000000011000010" },
          { bits: "1000000111000100" },
          { bits: "0000000101001000", shows: "כפל" },
          { bits: "1000000011000010" },
          { bits: "1000000111000100" },
          { bits: "0000001001011000", shows: "חילוק" },
          { bits: "1000000011000010" },
          { bits: "0100000001001000", label: "ריבוע" },
          { bits: "1000010000110100" },
          { bits: "0000000000001000" },
          { bits: "1000000011001100" },
          { bits: "0000000110001000", shows: "מכפלה" },
          { bits: "1000000101010010" },
          { bits: "0100000001011000", label: "כפל" },
          { bits: "1000010000110100" },
          { bits: "0000000000001000" },
          { bits: "1000000011001100" },
          { bits: "0100000000001000", label: "מכפלה" },
          { bits: "1000000101011100" },
          { bits: "0100000001001000", label: "שוב" },
          { bits: "1000010000110100" },
          { bits: "0100000000001000" },
          ...
          { bits: "1000010100111100" },
          { bits: "1000010000110100" },
          { bits: "0000000110101000", shows: "שוב" },
          { bits: "1000001111000001" },
          { bits: "0000010001111000", shows: "סוף" },
          { bits: "1000000101010010" },
          { bits: "0100000000001000", label: "חילוק" },
          { bits: "1000000101011100" },
          { bits: "0100000001001000" },
          ...
          { bits: "0000000000001000" },
          { bits: "1000010000110100" },
          { bits: "0000001010111000", shows: "חלוקה" },
          { bits: "1000001111000011" },
          { bits: "0100000000001000" },
          { bits: "1000010100111100" },
          { bits: "0000010001111000", shows: "סוף" },
        ...
        steps: [
          { code: "1028 → A", row: 13, text: "החלק של הריבוע התקצר משבע עשרה פקודות לשש. ההתחלה שלו לא השתנתה: In0 נלקח בתור המונה ונשמר בכתובת 0." },
          { code: "מכפלה → A", row: 17, text: "וכאן הכול שונה. במקום לולאה משלו, הריבוע מצביע על הכפל." },
          { code: "0 ; קפוץ אם =0", row: 18, text: "וקופץ אליו. שתי הפקודות האלה החליפו אחת עשרה." },
          { code: "1029 → A", row: 19, text: "הכפל מתחיל כמו קודם, והמונה שלו עדיין נלקח מ-In1. זה כל מה ששייך רק לו." },
          { code: "1024 → A", row: 23, text: "והתגית החדשה יושבת כאן, על הפקודה הראשונה שהשניים חולקים ממילא — איפוס Out0, ואחריו הלולאה. לשם הריבוע קופץ, אחרי שכבר שם את המונה שלו." }
        ],
        close: "אחת עשרה פקודות פחות — שבעים במקום שמונים ואחת — ולולאה אחת במקום שתיים. המחיר הוא שתי פקודות הקפיצה שהריבוע משלם בכל הרצה, ובבדיקה במכונה זה ארבעה צעדים בסך הכול. זו העסקה הרגילה בתכנות, ולרוב היא משתלמת."
      }
    ]
    }
  ];
