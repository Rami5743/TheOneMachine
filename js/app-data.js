...
And ו־Not הם כרטיסים שמבצעים חישוב.`,
  ...
  const DEMO_TASKS = [
    ...
    },
    {
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 5", text: "שים לב שגם המספר 0 צריך להופיע, ושכאשר ב-In0 יש 0 אסור להוסיף כלום. הדרך הפשוטה: תכתוב קודם את ההוספה ואחריה את הבדיקה, ובתחילת התוכנה תקפוץ ישר אל הבדיקה — כך היא נעשית עוד לפני ההוספה הראשונה." },
        { kind: "text", title: "רמז 6", text: "תן תגית גם לשורה שבה מתחילה ההוספה וגם לשורה שבה מתחילה הבדיקה, והגמד ימלא את שני המספרים בשבילך." },
      ...
      solution: [
        {
          title: "פתרון",
          lead: "מוסיפים 1, ואז בודקים אם עוד לא הגענו — ואם עוד לא, קופצים אחורה אל ההוספה. הכניסה ללולאה היא ישר אל הבדיקה, כדי שגם 0 ייבדק לפני שמוסיפים לו משהו.",
          steps: [
            ...
            { code: "בדיקה → A", bits: "0000000001111000", shows: "בדיקה", text: "ועכשיו קופצים ישר אל הבדיקה, מעל ההוספה. אחרת היינו מוסיפים 1 לפני שבדקנו בכלל — וכש-In0 הוא 0 זאת כבר טעות." },
            { code: "0 ; קפוץ אם =0", bits: "1000000101010010", text: "הקפיצה עצמה: ה-ALU מחשב 0, והתנאי מתקיים תמיד." },
            { code: "הוספה:  1024 → A", bits: "0100000000001000", label: "הוספה", text: "כאן מתחילה ההוספה, ולכן יש לשורה תגית. שוב כתובת Out0 ל-A." },
            { code: "*A+1 → *A", bits: "1000011110111100", text: "ומוסיפים לו 1. זה כל מה שהלולאה עושה." },
            { code: "בדיקה:  1024 → A", bits: "0100000000001000", label: "בדיקה", text: "וכאן מתחילה הבדיקה — גם לה תגית, כי קפצנו אליה מלמעלה. שוב כתובת Out0." },
            { code: "*A → D", bits: "1000010000110100", text: "לוקחים ל-D את המספר שמוצג עכשיו." },
            ...
            { code: "הוספה → A", bits: "0000000001011000", shows: "הוספה", text: "מכינים את היעד של הקפיצה אחורה: התגית הוספה, שורה 5." },
            { code: "D ; קפוץ אם <0", bits: "1000000011000001", text: "ואם עוד לא הגענו — חוזרים להוסיף עוד 1. כשההפרש כבר לא שלילי המחשב ממשיך לשורה הבאה, שהיא ריקה, ושם התוכנה נגמרת." }
          ],
          close: "שתים עשרה פקודות, ובלי אף קפיצה קדימה מלבד זאת שנכנסת ללולאה. שים לב שהמספר האחרון שהופיע הוא בדיוק זה שב-In0 — הבדיקה נעשית אחרי שהוא כבר הוצג."
        }
      ]
    },
    {
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 4", text: "בכל סיבוב: אם המונה כבר לא חיובי — לסוף. אחרת להוסיף את In0 ל-Out0, להוריד 1 מהמונה, ולחזור." },
        { kind: "text", title: "רמז 5", text: "\"אם המונה כבר לא חיובי\" זה בדיוק תנאי הקפיצה ≤0. הוא מכסה גם את המקרה שבו In1 הוא 0, ואז התוצאה צריכה להישאר 0." },
      ...
      solution: [
        {
          title: "פתרון",
          lead: "מחברים את In0 לתוצאה שוב ושוב, In1 פעמים. המונה — כמה פעמים עוד נשאר — יושב בכתובת 0 של הזיכרון.",
          steps: [
            ...
            { code: "לולאה:  0 → A", bits: "0000000000001000", label: "לולאה", text: "תחילת הלולאה: קודם כל חוזרים לכתובת של המונה." },
            { code: "*A → D", bits: "1000010000110100", text: "ומביאים אותו ל-D כדי לבדוק אותו." },
            { code: "סוף → A", bits: "0000000100111000", shows: "סוף", text: "מכינים את היעד של הקפיצה קדימה — שורת הסיום." },
            { code: "D ; קפוץ אם ≤0", bits: "1000000011000011", text: "אם המונה כבר לא חיובי — סיימנו. גם כש-In1 הוא 0 נצא כאן מיד, והתוצאה תישאר 0." },
            { code: "1028 → A", bits: "0100000001001000", text: "עוד יש מה לחבר: כתובת הקלט In0." },
            { code: "*A → D", bits: "1000010000110100", text: "מביאים את המספר שמחברים ל-D." },
            ...
            { code: "לולאה → A", bits: "0000000001111000", shows: "לולאה", text: "היעד של הקפיצה אחורה: התגית לולאה, שורה 7." },
            { code: "0 ; קפוץ אם =0", bits: "1000000101010010", text: "וחוזרים לתחילת הלולאה." },
            { code: "סוף:", bits: "", label: "סוף", field: "label", text: "והסוף: שורה ריקה שנושאת רק את התגית. המחשב מגיע אליה, לא מוצא פקודה, והתוצאה נשארת ב-Out0." }
          ],
          close: "שמונה עשרה פקודות: שש להתארגנות ושתים עשרה בלולאה. שים לב שהמכונה מבצעת כאן In1 סיבובים — להכפיל ב-1000 ייקח לה פי אלף יותר זמן מלהכפיל ב-1."
        }
      ]
    },
    {
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 4", text: "בכל סיבוב: מחשבים מה שנשאר פחות In1. אם התוצאה שלילית — כבר אי אפשר להוריד עוד, ולסוף. אחרת שומרים את התוצאה החדשה, מוסיפים 1 ל-Out0, וחוזרים." },
        { kind: "text", title: "רמז 5", text: "תנאי הקפיצה שאתה צריך הוא <0, ולא =0: קופצים לסוף רק כשמה שנשאר קטן מ-In1." },
        { kind: "text", title: "רמז 6", text: "התוצאה של החיסור כבר יושבת ב-D אחרי הבדיקה — אתה לא צריך לחשב אותה פעם שנייה. אם לא קפצת, פשוט תכתוב אותה חזרה." },
        { kind: "text", title: "רמז 7", text: "כמו תמיד — כל כתובת נקבעת מחדש בכל סיבוב, כי הקפיצה דרסה את A." }
      ],
      solution: [
        {
          title: "פתרון",
          lead: "מורידים את In1 ממה שנשאר שוב ושוב, וסופרים כמה פעמים הצלחנו. מה שנשאר יושב בכתובת 0 של הזיכרון.",
          steps: [
            { code: "1024 → A", bits: "0100000000001000", text: "כתובת הפלט Out0." },
            ...
            { code: "לולאה:  0 → A", bits: "0000000000001000", label: "לולאה", text: "תחילת הלולאה: חוזרים לכתובת של מה שנשאר." },
            { code: "*A → D", bits: "1000010000110100", text: "ומביאים אותו ל-D." },
            { code: "1029 → A", bits: "0100000001011000", text: "כתובת הקלט In1 — המספר שמחלקים בו." },
            { code: "D-*A → D", bits: "1000011100100100", text: "מחסרים: ב-D יש עכשיו מה שנשאר פחות In1." },
            { code: "סוף → A", bits: "0000000100111000", shows: "סוף", text: "מכינים את היעד של הקפיצה קדימה." },
            { code: "D ; קפוץ אם <0", bits: "1000000011000001", text: "אם ההפרש שלילי — In1 כבר לא נכנס במה שנשאר, וסיימנו." },
            { code: "0 → A", bits: "0000000000001000", text: "נכנס: חוזרים לכתובת של מה שנשאר." },
            { code: "D → *A", bits: "1000000011001100", text: "וכותבים אליה את ההפרש שכבר חישבנו." },
            { code: "1024 → A", bits: "0100000000001000", text: "כתובת המנה." },
            { code: "*A+1 → *A", bits: "1000011110111100", text: "ומוסיפים לה 1 — הורדנו את In1 עוד פעם אחת." },
            { code: "לולאה → A", bits: "0000000001111000", shows: "לולאה", text: "היעד של הקפיצה אחורה: התגית לולאה, שורה 7." },
            { code: "0 ; קפוץ אם =0", bits: "1000000101010010", text: "וחוזרים לתחילת הלולאה." },
            { code: "סוף:", bits: "", label: "סוף", field: "label", text: "והסוף: שורה ריקה שנושאת רק את התגית. המחשב מגיע אליה, לא מוצא פקודה, והמנה נשארת ב-Out0." }
          ],
          close: "שמונה עשרה פקודות, ובדיוק אותו מבנה כמו הכפל — רק שבמקום לחבר, מחסרים, ובמקום לספור עד שנגמר המונה, סופרים עד שנגמר מה שנשאר."
        }
      ]
    }
  ];
  ...
  const PROGRAM_COUNT_TO_TEST = {
    ...
    cycles: 3000,
    startOut: 500,
    cases: [[0, 0, 0], [1, 0, 1], [5, 0, 5], [12, 0, 12]],
    passTitle: "הבדיקה הצליחה",
  ...
  const PROGRAM_MULTIPLY_TEST = {
    ...
    startOut: 500,
    inputs: 2,
    cases: [[0, 7, 0], [7, 0, 0], [1, 1, 1], [3, 4, 12], [12, 9, 108], [25, 25, 625]],
    passTitle: "הבדיקה הצליחה",
  ...
  const PROGRAM_DIVIDE_TEST = {
    ...
    startOut: 500,
    inputs: 2,
    cases: [[0, 3, 0], [2, 3, 0], [3, 3, 1], [7, 2, 3], [100, 10, 10], [99, 7, 14]],
    passTitle: "הבדיקה הצליחה",
