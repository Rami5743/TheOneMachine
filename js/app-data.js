...
// references to app.js internals) and to never be mutated after declaration.
  ...
  const TASK_HINTS = {
    ...
    Add4: [
      ...
      { kind: "text", title: "רמז 4", text: "כמו בחיבור בטור, ספרת האחדות של הסכום היא כבר ספרת האחדות של התוצאה. את ספרת ה-2 (הנשיאה) אתה צריך לשמור בשביל הפעולה הבאה." },
      { kind: "text", title: "רמז 5", text: "עכשיו אתה צריך לחשב את הספרה הבאה. חבר את שתי הספרות הבאות של המספרים, אבל אל תשכח להוסיף עליהן את הנשיאה מהפעולה הקודמת — שוב בעזרת fullAdder." },
      { kind: "text", title: "רמז 6", text: "מכאן ממשיכים הלאה באותו אופן עד הספרה האחרונה. הנשיאה האחרונה היא הספרה המובילה של הסכום." }
    ],
    Mux4way16: [
      { kind: "text", title: "רמז 1", text: "תתחיל מלפצל את בס הבקרה לשני הביטים שלו." },
