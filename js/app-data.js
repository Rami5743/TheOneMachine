...
AND ו־NOT הם כרטיסים שמבצעים חישוב.`,
  ...
  // Chapter 2.4 component monologues (first person, like NAND_MONOLOGUE_TEXTS).
  // Shown when the learner clicks the two new crate hotspots in the 2.4 worktable.
  const BUS_MONOLOGUE = [
    "שלום, אני בּס. עד עכשיו כל חוט שראית העביר ביט אחד בלבד. אני אוגד בתוכי כמה חוטים יחד, וכך אני מעביר הרבה ביטים בבת אחת.",
    "המספר שכתוב עליי אומר כמה ביטים אני מעביר. כאן אני מעביר 16 ביטים יחד — כאילו יש בתוכי 16 חוטים נפרדים, אבל הכול ארוז בכבל אחד מסודר.",
    "כשעובדים עם מספרים גדולים זה הרבה יותר נוח: במקום למתוח 16 חוטים בודדים, מותחים אותי — בּס אחד."
  ];

  const SPLITTER_MONOLOGUE = [
    "ואני המפצל. התפקיד שלי הוא לקחת בּס אחד ולחלק אותו לכמה חלקים, או לחבר כמה חלקים בחזרה לבּס אחד. אני עובד לשני הכיוונים.",
    "אני תמיד מחלק בצורה שווה. אם נכנס אליי בּס של 16 ביטים ואני מפצל אותו לארבעה, כל יציאה תקבל בדיוק 4 ביטים.",
    "אפשר לשנות לכמה חלקים אני מפצל, אבל החלוקה תמיד תישאר שווה."
  ];
