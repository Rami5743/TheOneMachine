  ...
  const CASES_TASKS = [
    {
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 5", text: "חיבור וחיסור לא צריכים לולאה בכלל: תביא את In0 ל-D, תקבע את A על הכתובת של In1, ותחשב D+*A (או D-*A) ישר לתוך Out0. זו כל התוכנה — שלוש-ארבע פקודות." },
      ...
      },
      {
        ...
        { code: "1028 → A", row: 56, text: "החיבור הוא הקצר מכולם: In0 ל-D, ואז D+*A כשב-A יושבת הכתובת של In1 — והתוצאה ישר ל-Out0. שש פקודות, בלי לולאה." },
