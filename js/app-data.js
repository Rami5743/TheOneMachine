...
And ו־Not הם כרטיסים שמבצעים חישוב.`,
  ...
  const DEMO_TASKS = [
    ...
    },
    {
      ...
      solution: [
        {
          title: "פתרון",
          lead: "מחברים את In0 לתוצאה שוב ושוב, In1 פעמים. המונה — כמה פעמים עוד נשאר — יושב בכתובת 0 של הזיכרון, ומכיוון שב-In1 יש לפחות 1 אפשר לחבר קודם ולשאול אחר כך, כך שצריך קפיצה אחת בלבד.",
          steps: [
  ...
  const PROGRAM_COUNT_TO_TEST = {
    ...
    cycles: 3000,
    startOut: 500,
    cases: [[1, 0, 1], [2, 0, 2], [5, 0, 5], [12, 0, 12]],
    passTitle: "הבדיקה הצליחה",
  ...
  const PROGRAM_MULTIPLY_TEST = {
    ...
    startOut: 500,
    inputs: 2,
    cases: [[1, 1, 1], [7, 1, 7], [1, 7, 7], [3, 4, 12], [12, 9, 108], [25, 25, 625]],
    passTitle: "הבדיקה הצליחה",
