      ...
      solution: [
        {
          ...
          steps: [
            { code: "0 → D", bits: "1000000101010100", text: "זאת הפעולה שתחזור על עצמה. בחרנו פעולה שעושה בכל סיבוב בדיוק את אותו הדבר — כותבת 0 ל-D. אין שום חשיבות לאיזו פעולה בחרנו: המשימה רק דורשת שהמכונה תמשיך לבצע פקודות. אפשר היה לכתוב כאן פקודה שלא כותבת לשום מקום בכלל." },
