      ...
      steps: [
        {
          ...
          parts: [
            ...
            { from: 15, to: 16, text: "שני הביטים האחרונים לא משפיעים על כלום, ולכן הם אפסים." }
          ]
        },
        {
          code: "D=*A",
          ...
          parts: [
            ...
            { from: 2, to: 5, text: "ארבעת הביטים האלה לא משמשים לכלום כשה-ALU מחשב, ולכן הם אפסים." },
            ...
            { from: 15, to: 16, text: "ושוב שני ביטים שלא משפיעים על כלום." }
          ]
        },
        {
          code: "A=1024",
        ...
        },
        {
          ...
          parts: [
            ...
            { from: 2, to: 5, text: "אפסים, כרגיל בפקודת חישוב." },
            { from: 6, to: 6, text: "כאן לא משנה על מי ה-ALU עובד חוץ מ-D, כי ההוראה הבאה משתמשת רק ב-D." },
  ...
  const PROGRAM_SOLUTIONS = [
    {
      ...
      steps: [
        { code: "A=1028", bits: "0100000001001000", text: "כתובת הקלט In0 היא 1028. קודם כל נכניס אותה ל-A, כדי שנוכל לקרוא את הקלט עם ‎*A." },
        { code: "D=0", bits: "0000000000000100", text: "מתחילים מאפס. אין כאן שום חישוב — הפקודה פשוט מוציאה את המספר 0 וכותבת אותו ל-D. זה המספר שאליו נחבר את הקלט שוב ושוב." },
        { code: "D=D+*A", bits: "1000010100000100", text: "החיבור הראשון. עכשיו ב-D יש את הקלט פעם אחת." },
        { code: "D=D+*A", bits: "1000010100000100", text: "החיבור השני. ב-D יש פי 2." },
        { code: "D=D+*A", bits: "1000010100000100", text: "החיבור השלישי. ב-D יש פי 3." },
        { code: "D=D+*A", bits: "1000010100000100", text: "החיבור הרביעי. ב-D יש פי 4. שים לב שכל השורות האלה זהות — אפשר לסמן אחת ולהדביק אותה שוב ושוב במקום לכתוב אותה מחדש." },
        { code: "D=D+*A", bits: "1000010100000100", text: "החיבור החמישי. ב-D יש פי 5." },
        { code: "D=D+*A", bits: "1000010100000100", text: "החיבור השישי. ב-D יש פי 6." },
        { code: "D=D+*A", bits: "1000010100000100", text: "החיבור השביעי. ב-D יש פי 7." },
        { code: "D=D+*A", bits: "1000010100000100", text: "החיבור השמיני. ב-D יש פי 8 — זאת התשובה." },
        { code: "A=1024", bits: "0100000000001000", text: "סיימנו לחשב. כתובת הפלט Out0 היא 1024, ולכן נכניס אותה ל-A." },
        { code: "*A=D", bits: "1000000011001100", text: "כותבים את מה שב-D לכתובת שנמצאת ב-A, כלומר ל-Out0. זהו." }
      ],
    ...
    },
    {
      ...
      steps: [
        { code: "A=1028", bits: "0100000001001000", text: "שוב מתחילים מכתובת הקלט." },
        { code: "D=*A", bits: "1000010000110100", text: "הפעם פשוט לוקחים את הקלט אל D." },
        { code: "A=D", bits: "1000000011001000", text: "וזה הטריק: מעתיקים את D גם ל-A. עכשיו אותו מספר נמצא בשני הרגיסטרים." },
        { code: "D=D+A", bits: "1000000100000100", text: "מחברים את D לעצמו, ובזה הכפלנו אותו. ב-D יש פי 2." },
        { code: "A=D", bits: "1000000011001000", text: "שוב מעתיקים את D ל-A..." },
        { code: "D=D+A", bits: "1000000100000100", text: "...ומכפילים שוב. ב-D יש פי 4." },
        { code: "A=D", bits: "1000000011001000", text: "ובפעם השלישית." },
        { code: "D=D+A", bits: "1000000100000100", text: "ב-D יש פי 8 — אחרי שלוש הכפלות בלבד." },
        { code: "A=1024", bits: "0100000000001000", text: "כתובת הפלט." },
        { code: "*A=D", bits: "1000000011001100", text: "וכותבים אותה החוצה." }
      ],
