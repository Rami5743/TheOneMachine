  ...
  const RAM_TASKS = [
    {
      ...
      addressWidth: 2,
      controlPinX: -217,
      innerCardSpots: [[740, 365], [695, 460], [630, 570], [525, 675]],
      slots: 4,
      clocked: true,
    ...
    },
    {
      ...
      addressWidth: 4,
      controlPinX: -217,
      innerCardSpots: [[740, 320], [720, 440], [650, 555], [530, 650]],
      slots: 16,
      clocked: true,
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 5", text: "זה אומר שאתה משתמש בשני הביטים הראשונים של הכתובת כדי לקבוע לאיזה RAM4 אתה כותב ומאיזה RAM4 אתה קורא, ושני הביטים האחרונים יהיו ביט הכתובת של ה-RAM4 שתשתמש בו." },
        ...
        { kind: "text", title: "רמז 7", text: "בשביל זה אתה משתמש ב-DMUX וב-MUX בדיוק כמו שעשית ב-RAM4" }
      ]
    },
    {
      id: "RAM64",
      ...
      hints: [
        { kind: "text", title: "רמז 1", text: "ה-RAM64 הוא בדיוק אותו רעיון כמו ה-RAM4, רק שבמקום 4 רגיסטרים יש בתוכו 4 כרטיסי RAM16." },
        { kind: "interactive", title: "רמז 2", action: "ram-place-inner-cards", confirmBeforeApply: true, applyLabel: "כן", text: "אניח בשבילך את 4 כרטיסי ה-RAM16 בתוך המסגרת. (שים לב: זה ימחק את מה שבנית עד עכשיו)." },
        { kind: "text", title: "רמז 3", text: "הכתובת היא 6 ביטים. שזה 64 אפשרויות. אתה צריך לחלק את האפשרויות ל-4 קבוצות, ועבור כל 16 אפשרויות להשתמש ב-RAM16" },
        { kind: "text", title: "רמז 4", text: "אתה יכול להחליט ששני הביטים הראשונים יקבעו את הקבוצה, וארבעת הביטים האחרונים יקבעו את הרגיסטר בתוך הקבוצה." },
        { kind: "text", title: "רמז 5", text: "זה אומר שאתה משתמש בשני הביטים הראשונים של הכתובת כדי לקבוע לאיזה RAM16 אתה כותב ומאיזה RAM16 אתה קורא, וארבעת הביטים האחרונים יהיו ביט הכתובת של ה-RAM16 שתשתמש בו." },
        { kind: "text", title: "רמז 6", text: "שים לב, אתה יכול לשלוח את ארבעת הביטים האחרונים של הכתובת לכל ארבעת כרטיסי ה-RAM16. בדיוק כמו שאתה יכול לשלוח את כניסת הדאטה לארבעתם. אתה רק צריך להקפיד שביט הבקרה יהיה 0 אצל כולם חוץ מאחד ואז אתה תכתוב רק לרגיסטר שאתה רוצה. בסוף אתה גם צריך להתעלם ביציאות של כל כרטיסי ה-RAM16 חוץ מאחד, כך שתקבל את התוכן של הרגיסטר שבחרת." },
        { kind: "text", title: "רמז 7", text: "בשביל זה אתה משתמש ב-DMUX וב-MUX בדיוק כמו שעשית ב-RAM4" }
      ]
    },
    {
      ...
      hints: [
        { kind: "text", title: "רמז 1", text: "ה-RAM256 הוא בדיוק אותו רעיון כמו ה-RAM4, רק שבמקום 4 רגיסטרים יש בתוכו 4 כרטיסי RAM64." },
        { kind: "interactive", title: "רמז 2", action: "ram-place-inner-cards", confirmBeforeApply: true, applyLabel: "כן", text: "אניח בשבילך את 4 כרטיסי ה-RAM64 בתוך המסגרת. (שים לב: זה ימחק את מה שבנית עד עכשיו)." },
        { kind: "text", title: "רמז 3", text: "הכתובת היא 8 ביטים. שזה 256 אפשרויות. אתה צריך לחלק את האפשרויות ל-4 קבוצות, ועבור כל 64 אפשרויות להשתמש ב-RAM64" },
        { kind: "text", title: "רמז 4", text: "אתה יכול להחליט ששני הביטים הראשונים יקבעו את הקבוצה, וששת הביטים האחרונים יקבעו את הרגיסטר בתוך הקבוצה." },
        { kind: "text", title: "רמז 5", text: "זה אומר שאתה משתמש בשני הביטים הראשונים של הכתובת כדי לקבוע לאיזה RAM64 אתה כותב ומאיזה RAM64 אתה קורא, וששת הביטים האחרונים יהיו ביט הכתובת של ה-RAM64 שתשתמש בו." },
        { kind: "text", title: "רמז 6", text: "שים לב, אתה יכול לשלוח את ששת הביטים האחרונים של הכתובת לכל ארבעת כרטיסי ה-RAM64. בדיוק כמו שאתה יכול לשלוח את כניסת הדאטה לארבעתם. אתה רק צריך להקפיד שביט הבקרה יהיה 0 אצל כולם חוץ מאחד ואז אתה תכתוב רק לרגיסטר שאתה רוצה. בסוף אתה גם צריך להתעלם ביציאות של כל כרטיסי ה-RAM64 חוץ מאחד, כך שתקבל את התוכן של הרגיסטר שבחרת." },
        { kind: "text", title: "רמז 7", text: "בשביל זה אתה משתמש ב-DMUX וב-MUX בדיוק כמו שעשית ב-RAM4" }
      ]
    },
    {
      ...
      hints: [
        { kind: "text", title: "רמז 1", text: "ה-RAM1024 הוא בדיוק אותו רעיון כמו ה-RAM4, רק שבמקום 4 רגיסטרים יש בתוכו 4 כרטיסי RAM256." },
        { kind: "interactive", title: "רמז 2", action: "ram-place-inner-cards", confirmBeforeApply: true, applyLabel: "כן", text: "אניח בשבילך את 4 כרטיסי ה-RAM256 בתוך המסגרת. (שים לב: זה ימחק את מה שבנית עד עכשיו)." },
        { kind: "text", title: "רמז 3", text: "הכתובת היא 10 ביטים. שזה 1024 אפשרויות. אתה צריך לחלק את האפשרויות ל-4 קבוצות, ועבור כל 256 אפשרויות להשתמש ב-RAM256" },
        { kind: "text", title: "רמז 4", text: "אתה יכול להחליט ששני הביטים הראשונים יקבעו את הקבוצה, ושמונת הביטים האחרונים יקבעו את הרגיסטר בתוך הקבוצה." },
        { kind: "text", title: "רמז 5", text: "זה אומר שאתה משתמש בשני הביטים הראשונים של הכתובת כדי לקבוע לאיזה RAM256 אתה כותב ומאיזה RAM256 אתה קורא, ושמונת הביטים האחרונים יהיו ביט הכתובת של ה-RAM256 שתשתמש בו." },
        { kind: "text", title: "רמז 6", text: "שים לב, אתה יכול לשלוח את שמונת הביטים האחרונים של הכתובת לכל ארבעת כרטיסי ה-RAM256. בדיוק כמו שאתה יכול לשלוח את כניסת הדאטה לארבעתם. אתה רק צריך להקפיד שביט הבקרה יהיה 0 אצל כולם חוץ מאחד ואז אתה תכתוב רק לרגיסטר שאתה רוצה. בסוף אתה גם צריך להתעלם ביציאות של כל כרטיסי ה-RAM256 חוץ מאחד, כך שתקבל את התוכן של הרגיסטר שבחרת." },
        { kind: "text", title: "רמז 7", text: "בשביל זה אתה משתמש ב-DMUX וב-MUX בדיוק כמו שעשית ב-RAM4" }
      ]
    }
  ];
