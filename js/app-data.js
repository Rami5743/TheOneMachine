...
And ו־Not הם כרטיסים שמבצעים חישוב.`,
  ...
  // Registers), so its frame arrives with those four cards already inside and the
  // learner wires the addressing around them. Like the 3.1 memory cards these are
  ...
  const RAM_TASKS = [
    {
      ...
      hints: [
        { kind: "text", title: "רמז 1", text: "כניסת הבקרה צריכה להגיע רק לרגיסטר אחד — זה שהכתובת מצביעה עליו. כל שאר הרגיסטרים צריכים לקבל 0 בכניסת הבקרה שלהם, כדי שהמידע ששמור בהם לא ישתנה." },
        { kind: "text", title: "רמז 2", text: "כניסת הדאטה יכולה להתחבר לכל ארבעת הרגיסטרים במקביל. זה לא מפריע, כי רק הרגיסטר שכניסת הבקרה שלו היא 1 באמת ישמור את המידע." },
        { kind: "text", title: "רמז 3", text: "פצל את בס הכתובת לשני כבלים בודדים. DMux מעביר כניסה אחת לאחת משתי יציאות לפי כבל בקרה, כך שבשני שלבים של DMux אפשר להעביר את כניסת הבקרה לאחד מתוך ארבעה." },
        { kind: "text", title: "רמז 4", text: "ליציאה: MUX16 בוחר בין שני בסים לפי כבל בקרה אחד. שלושה כרטיסי MUX16 בשני שלבים בוחרים אחד מתוך ארבעה — לפי אותם שני ביטים של הכתובת." }
      ]
    },
    {
      id: "RAM16",
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 2", text: "פצל את בס הכתובת (4 ביטים) לשניים: 2 ביטים שנכנסים לכניסת הכתובת של כל ארבעת ה-RAM4, ו-2 ביטים שבוחרים לאיזה מהם פונים." },
        { kind: "text", title: "רמז 3", text: "2 ביטי הכתובת הפנימיים מתחברים לכל ארבעת הכרטיסים במקביל. שני הביטים האחרים מנתבים את כניסת הבקרה (DMux) ובוחרים את היציאה (MUX16) — בדיוק כמו ב-RAM4." }
      ]
    },
    {
      id: "RAM64",
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 2", text: "פצל את בס הכתובת (6 ביטים) לשניים: 4 ביטים שנכנסים לכניסת הכתובת של כל ארבעת ה-RAM16, ו-2 ביטים שבוחרים לאיזה מהם פונים." },
        { kind: "text", title: "רמז 3", text: "4 ביטי הכתובת הפנימיים מתחברים לכל ארבעת הכרטיסים במקביל. שני הביטים האחרים מנתבים את כניסת הבקרה (DMux) ובוחרים את היציאה (MUX16) — בדיוק כמו ב-RAM4." }
      ]
    },
    {
      id: "RAM256",
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 2", text: "פצל את בס הכתובת (8 ביטים) לשניים: 6 ביטים שנכנסים לכניסת הכתובת של כל ארבעת ה-RAM64, ו-2 ביטים שבוחרים לאיזה מהם פונים." },
        { kind: "text", title: "רמז 3", text: "6 ביטי הכתובת הפנימיים מתחברים לכל ארבעת הכרטיסים במקביל. שני הביטים האחרים מנתבים את כניסת הבקרה (DMux) ובוחרים את היציאה (MUX16) — בדיוק כמו ב-RAM4." }
      ]
    },
    {
      id: "RAM1024",
      ...
      hints: [
        ...
        { kind: "text", title: "רמז 2", text: "פצל את בס הכתובת (10 ביטים) לשניים: 8 ביטים שנכנסים לכניסת הכתובת של כל ארבעת ה-RAM256, ו-2 ביטים שבוחרים לאיזה מהם פונים." },
        { kind: "text", title: "רמז 3", text: "8 ביטי הכתובת הפנימיים מתחברים לכל ארבעת הכרטיסים במקביל. שני הביטים האחרים מנתבים את כניסת הבקרה (DMux) ובוחרים את היציאה (MUX16) — בדיוק כמו ב-RAM4." }
      ]
    }
  ];
