  ...
  const INSTRUCTION_SHEET = [
    ...
    { code: "D=*A-D",  bits: "1000011110001000", after: { A: 1, D: 12, R0: 0, R1: 17, R2: 0 },
      hints: [
        ...
        { title: "רמז 6", text: "רוצה שאעתיק לך את המצב של כל הרגיסטרים שלא השתנו?", fill: { A: 1, R0: 0, R1: 17, R2: 0 }, applyLabel: "כן, העתק" }
      ] },
    ...
    { code: "*A=D",    bits: "1000000011001100", after: { A: 2, D: 12, R0: 0, R1: 17, R2: 12 },
      hints: [
        ...
        { title: "רמז 3", text: "ששת הביטים האלה אומרים ל-ALU להוציא את הכניסה הראשונה שלו כמו שהיא, כלומר את D.", mark: [7, 12] },
        ...
        { title: "רמז 6", text: "רוצה שאעתיק לך את המצב של כל הרגיסטרים שלא השתנו?", fill: { A: 2, D: 12, R0: 0, R1: 17 }, applyLabel: "כן, העתק" }
      ] }
  ];
