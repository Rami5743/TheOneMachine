  ...
  const CASES_TASKS = [
    {
      ...
      solution: [
      {
        ...
        { code: "חיבור → A", bits: "0000001110011000", shows: "חיבור", text: "לפני כל קפיצה צריך לומר לאן. כאן זו השורה שבה מתחיל החיבור — ובמקום מספר כתבנו את שם התגית שלה, והגמד ימלא את הביטים." },
        ...
        { code: "חיסור → A", bits: "0000010000011000", shows: "חיסור", text: "היעד הבא: החיסור." },
        ...
        { code: "כפל → A", bits: "0000000101001000", shows: "כפל", text: "היעד הבא: הכפל." },
        { code: "D ; קפוץ אם =0", bits: "1000000011000010", text: "ועכשיו הבדיקה שואלת על 2." },
        { code: "D-1 → D", bits: "1000000111000100", text: "ועוד אחד." },
        { code: "חילוק → A", bits: "0000001001011000", shows: "חילוק", text: "היעד הבא: החילוק." },
      ...
      },
      {
        ...
        lead: "ומכאן זה כבר מוכר. חמשת החלקים יושבים אחד אחרי השני, לכל אחד תגית בשורה הראשונה שלו — התגיות שההחלטה קופצת אליהן. שניים מהם הם התוכנות ששמרת בפרק הקודם, מועתקות פנימה כמו שהן.",
        program: [
        ...
        steps: [
        { code: "1028 → A", row: 13, text: "ריבוע הוא כפל של In0 בעצמו, ולכן אין לו קוד משלו. כל מה שהוא עושה זה לקבוע כמה פעמים לחבר — In0 פעמים — ולשלוח את המכונה ללולאת הכפל." },
        { code: "D → *A", row: 16, text: "המונה נשמר בכתובת 0 של הזיכרון, בדיוק כמו בכפל של הפרק הקודם." },
        { code: "0 ; קפוץ אם =0", row: 18, text: "קפיצה שתמיד קורית: ה-ALU מחשב 0, והתנאי הוא שהתוצאה היא 0. ככה קופצים בלי תנאי." },
        { code: "1029 → A", row: 19, text: "הכפל עושה את אותו הדבר, רק שהמונה שלו הוא In1 — כמה פעמים לחבר את In0. אחריו אין קפיצה, כי הלולאה המשותפת מתחילה בשורה שאחריו." },
        { code: "1024 → A", row: 23, text: "וכאן שני החלקים נפגשים. מהשורה הזאת והלאה זו בדיוק תוכנת הכפל שכתבת בפרק הקודם, מילה במילה: מאפסים את Out0, ואז מחברים אליו את In0 שוב ושוב עד שהמונה נגמר." },
        { code: "1028 → A", row: 25, text: "תחילת הלולאה, ולכן יש לשורה תגית." },
        { code: "-D ; קפוץ אם <0", row: 33, text: "היציאה מהלולאה. אין פקודת קפיצה ששואלת \"האם גדול מ-0\", אז שואלים על מינוס D אם הוא קטן מ-0 — וזה אותו דבר." },
        { code: "0 ; קפוץ אם =0", row: 35, text: "וכשהלולאה נגמרה, קופצים לסוף. בלי הקפיצה הזאת החלק הזה היה ממשיך לזלוג לתוך החילוק שמתחתיו." },
        { code: "1024 → A", row: 36, text: "החילוק — גם הוא מועתק מהפרק הקודם בלי שינוי: מורידים את In1 מ-In0 שוב ושוב, וסופרים כמה פעמים הספקנו." },
        { code: "1029 → A", row: 42, text: "הלולאה שלו." },
        { code: "*A-1 → *A", row: 53, text: "והתיקון שבסופה: הלולאה סופרת גם את הפעם שבה כבר עברנו את האפס, אז מורידים אחד בחזרה." },
        { code: "1028 → A", row: 56, text: "החיבור הוא הקצר מכולם: In0 ל-D, ואז D+*A כשב-A יושבת הכתובת של In1. התוצאה נשמרת ב-D ולא נכתבת ישר לפלט — ב-A יושבת עכשיו כתובת של קלט, ולשם אי אפשר לכתוב — ולכן שתי הפקודות האחרונות קובעות את A על Out0 וכותבות אותה לשם. שש פקודות, בלי לולאה." },
        { code: "1028 → A", row: 64, text: "והחיסור זהה לו לגמרי חוץ מפקודה אחת: D-*A במקום D+*A." },
        { code: "סוף", row: 70, text: "והשורה הזאת ריקה — יש לה רק תגית. כל חלק שסיים את שלו קופץ לכאן, וכאן המכונה נעצרת, כי אין כאן פקודה." }
        ],
        close: "שבעים פקודות, ואף אחת מהן אינה חדשה. מה שחדש הוא ששלוש עשרה פקודות בראש התוכנה בוחרות איזו מהן תרוץ."
      }
    ]
    }
  ];
